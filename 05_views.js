...
const intro = magpieViews.view_generator("intro", {
  ...
  text: `Thank you for taking your time to particpate in my study!
            <br />
            <br />
            This study is concerned with the humans ability to recognize 3D objects from different locations in space.
            <br />
            <br />
            And with your help we will get more insight into the human brain :)`,
...
const instructions_main = magpieViews.view_generator("instructions", {
  ...
  title: 'Main Phase',
  // If you use JavaScripts Template String `I am a Template String`, you can use HTML <></> and javascript ${} inside
  text: `Now the main phase of the experiment begins. Remember: Try to be as fast and correct as possible!`,
  buttonText: 'Continue'
});
...
const identical_or_not = magpieViews.view_generator("key_press", {
  trials: keypress_geoms.key_press.length,
  name: 'identical_or_not',
  title: 'Mental Rotation',
  data: keypress_geoms.key_press,
});
*/

const training_phase = magpieViews.view_generator("key_press", {
  trials: trial_info.training.length,
  name: 'training_phase',
  data: _.shuffle(trial_info.training),
  pause: 250,
});

const main_phase = magpieViews.view_generator("key_press", {
